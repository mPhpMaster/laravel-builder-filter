...
use ReflectionClass;
use mPhpMaster\BuilderFilter\Exceptions\InvalidSubject;
use mPhpMaster\BuilderFilter\QueryBuilder;
use mPhpMaster\BuilderFilter\BuilderFilterRequest;
use mPhpMaster\BuilderFilter\Sorts\Sort;
use mPhpMaster\BuilderFilter\Tests\TestClasses\Models\NestedRelatedModel;
use mPhpMaster\BuilderFilter\Tests\TestClasses\Models\RelatedThroughPivotModel;
use mPhpMaster\BuilderFilter\Tests\TestClasses\Models\ScopeModel;
...
class QueryBuilderTest extends TestCase
{
    ...
    public function it_will_determine_the_request_when_its_not_given()
    {
        ...
        $this->assertInstanceOf(BuilderFilterRequest::class, $requestProperty->getValue($builder));
    ...
    public function it_executes_the_same_query_regardless_of_the_order_of_applied_filters_or_sorts()
    {
        ...
        $usingSortFirst = QueryBuilder::for(TestModel::class, $req)
            ->allowedSorts(\mPhpMaster\BuilderFilter\AllowedSort::custom('name', $customSort))
            ->allowedFilters('name')
            ->toSql();
