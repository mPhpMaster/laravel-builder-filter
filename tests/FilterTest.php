...
use mPhpMaster\BuilderFilter\Exceptions\InvalidFilterQuery;
use mPhpMaster\BuilderFilter\Filters\Filter as CustomFilter;
use mPhpMaster\BuilderFilter\Filters\Filter as FilterInterface;
...
class FilterTest extends TestCase
{
    ...
    {
        config(['builder-filter.disable_invalid_filter_query_exception' => true]);
