...
use mPhpMaster\BuilderFilter\Filters\FiltersCallback;
use mPhpMaster\BuilderFilter\Filters\FiltersExact;
use mPhpMaster\BuilderFilter\Filters\FiltersPartial;
use mPhpMaster\BuilderFilter\Filters\FiltersScope;
use mPhpMaster\BuilderFilter\Filters\FiltersTrashed;

class AllowedFilter
{
    /** @var \mPhpMaster\BuilderFilter\Filters\Filter */
    ...
    {
        if (isset($delimiter)) {
            BuilderFilterRequest::setFilterArrayValueDelimiter($delimiter);
        }
    }
