...
namespace mPhpMaster\BuilderFilter\Concerns;

use Illuminate\Support\Collection;
use Illuminate\Support\Str;
use mPhpMaster\BuilderFilter\AllowedInclude;
use mPhpMaster\BuilderFilter\Exceptions\InvalidIncludeQuery;
use mPhpMaster\BuilderFilter\Includes\IncludeInterface;
    ...
    public function allowedIncludes($includes): self
    {
        ...
        $this->allowedIncludes = collect($includes)
            ...
            ->flatMap(function ($include): Collection {
                ...
                if (Str::endsWith($include, config('builder-filter.count_suffix'))) {
