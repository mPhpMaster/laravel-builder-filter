...
class BuilderFilterRequest extends Request
{
    ...
    {
        $includeParameterName = config('builder-filter.parameters.include');
    ...
    {
        $appendParameterName = config('builder-filter.parameters.append');
    ...
    {
        $fieldsParameterName = config('builder-filter.parameters.fields');
    ...
    {
        $sortParameterName = config('builder-filter.parameters.sort');
    ...
    {
        $filterParameterName = config('builder-filter.parameters.filter');
