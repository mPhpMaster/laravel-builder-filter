...
use mPhpMaster\BuilderFilter\Concerns\AddsFieldsToQuery;
use mPhpMaster\BuilderFilter\Concerns\AddsIncludesToQuery;
use mPhpMaster\BuilderFilter\Concerns\AppendsAttributesToResults;
use mPhpMaster\BuilderFilter\Concerns\FiltersQuery;
use mPhpMaster\BuilderFilter\Concerns\SortsQuery;
...
class QueryBuilder implements ArrayAccess
{
    ...
    /** @var \mPhpMaster\BuilderFilter\BuilderFilterRequest */
    protected $request;
    ...
    protected function initializeRequest(?Request $request = null): self
    {
        $this->request = $request
            ? BuilderFilterRequest::fromRequest($request)
            : app(BuilderFilterRequest::class);
