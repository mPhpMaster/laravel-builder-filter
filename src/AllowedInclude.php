...
use mPhpMaster\BuilderFilter\Includes\IncludedCount;
use mPhpMaster\BuilderFilter\Includes\IncludedRelationship;
        ...
        return IncludedRelationship::getIndividualRelationshipPathsFromInclude($internalName)
            ...
            ->flatMap(function ($args): Collection {
                ...
                if (! Str::contains($relationship, '.')) {
                    $suffix = config('builder-filter.count_suffix');
